...
The application is based on Redis caching to minimize database recalling during redirection and is fully containerized with Docker for consistent deployment
...
# Redis
REDIS_URL=redis://redis:6379  # Use redis://localhost:6379 for local non-docker run
